...
<?php echo form_open('auth/signup',array('class' => "form-signin" )); ?>
<h2 class="form-signin-heading">Sign Up to Site!</h2>
	...
	<?php echo anchor('auth/login/', 'Sign In!', 'id="signup" class="link-class btn btn-large"'); ?>
</form>
